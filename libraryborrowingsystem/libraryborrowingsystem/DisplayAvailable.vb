...
Public Class DisplayAvailable
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Me.Hide()
    End Sub
    Private Sub DisplayAvailable_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadBooks("")
    End Sub
    ...
    Private Sub LoadBooks(Optional searchQuery As String = "")
        ...
        Dim query As String = "SELECT * FROM displayBooks WHERE Status = 'Available' AND (Title LIKE @search OR Author LIKE @search)"
